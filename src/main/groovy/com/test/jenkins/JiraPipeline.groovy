    ...
    def jiraPhase() {
        script.stage('Deploy') {
            script.node('master') {
                def constants = [
                        "jira": [
                                "serverUrl": System.getenv('JIRA_SERVER_URL') ?: "https://jira-stg.na.intgdc.com"
                        ]
                ]
                try {
                    ...
                    String jiraUserName = System.getenv('JIRA_USER_NAME') ?: 'admin'
                    String jiraPassword = System.getenv('JIRA_PASSWORD') ?: 'admin'
